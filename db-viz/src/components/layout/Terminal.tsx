        ...
        {!isMinimized && (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex items-center px-3 pb-3">
              <span className="text-green-400 font-mono">mysql&gt;</span>
              <input
                ref={inputRef}
                type="text"
                value={input}
                ...
                className="flex-1 bg-transparent border-none outline-none text-white font-mono text-sm ml-2 placeholder:text-gray-600"

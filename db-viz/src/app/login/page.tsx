...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-gray-900">
      {/* Left Side - Benefits */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-violet-700 p-12 flex-col justify-between">
        <div>
          <motion.div
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none p-8 border border-slate-200 dark:border-gray-700">
          ...
          >
            <button
              onClick={() => router.push('/')}
              className="text-slate-600 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-white transition-colors"
            >
              ← Back to home
            </button>
          </motion.div>
